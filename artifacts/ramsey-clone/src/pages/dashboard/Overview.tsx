        ...
        {assets.map((a) => (
          ...
          >
            <div className="flex items-center gap-3">
              <div className="w-9 h-9 rounded-full bg-white/5 flex items-center justify-center text-sm font-bold">
                {a.icon || a.symbol[0]}
              </div>
              <div>
  ...
  return (
    <div>
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 mb-6">
        ...
        <div className="bg-[#111827] rounded-2xl border border-white/5 p-5">
          <div className="flex items-center justify-between mb-3">
            <p className="text-white/50 text-sm">Crypto Holdings</p>
            <span className="text-lg">₿</span>
          </div>
          <p className="text-2xl font-bold font-mono">$78,245.30</p>
          <p className="text-green-400 text-sm mt-1 flex items-center gap-1">
            <TrendingUp className="w-4 h-4" />
            +2.4% today
          </p>
        ...
        <div className="bg-[#111827] rounded-2xl border border-white/5 p-5">
          <div className="flex items-center justify-between mb-3">
            <p className="text-white/50 text-sm">Stock Holdings</p>
            <BarChart3 className="w-5 h-5 text-[#FCD214]" />
          </div>
          <p className="text-2xl font-bold font-mono">$46,338.12</p>
        ...
        <div className="bg-[#111827] rounded-2xl border border-white/5 p-5">
          <div className="flex items-center justify-between mb-3">
            <p className="text-white/50 text-sm">Available Cash</p>
            <DollarSign className="w-5 h-5 text-green-400" />
          </div>
          <p className="text-2xl font-bold font-mono">$12,450.00</p>
      ...
      <div className="bg-[#111827] rounded-2xl border border-white/5 p-5 mb-6">
        <div className="flex items-center justify-between mb-4">
          <div>
            ...
            <p className="text-white/40 text-xs mt-0.5">Last 24 hours</p>
          </div>
        ...
        <svg viewBox={`0 0 ${chartW} ${chartH + 20}`} className="w-full h-48">
          <defs>
            <linearGradient id="chartGrad" x1="0" y1="0" x2="0" y2="1">
              <stop offset="0%" stopColor="#0073B9" stopOpacity="0.3" />
