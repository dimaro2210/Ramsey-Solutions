    ...
    <div className="w-full bg-[#111] text-white min-h-screen">
      <div className="max-w-6xl mx-auto px-4 py-16">
        ...
        <div className="grid md:grid-cols-3 gap-6 mb-16">
          {[
            { title: "Debt-Free Screams", desc: "Watch real people scream their way to freedom on the show." },
            { title: "Caller Highlights", desc: "Hear from callers tackling real money questions every day." },
            { title: "Expert Advice", desc: "Get wisdom from Dave, Rachel, Ken, Dr. John Delony and more." },
          ].map((item, i) => (
